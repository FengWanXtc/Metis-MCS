...
data2['body']['VideoSpecs'][1]['DeviceId'] = Student_DeviceId
deviceid = requests.get("http://{}:6689/mediadevice/audio/out/configuration".format(IP), headers={'Content-type': 'application/json'}, json='')
data3['body']['DeviceId'] = deviceid.json()["AudioOuts"][0]["DeviceId"]
data4['body']['DeviceId'] = deviceid.json()["AudioOuts"][0]["DeviceId"]
