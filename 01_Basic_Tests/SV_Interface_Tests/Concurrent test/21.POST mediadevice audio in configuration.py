...
data['body']['SubDevices'][0]["Id"] = deviceid.json()["AudioIns"][0]["SubDevices"][0]["Id"]
data['body']['SubDevices'][1]["Id"] = deviceid.json()["AudioIns"][0]["SubDevices"][1]["Id"]
data2['body']['SubDevices'][0]["Id"] = deviceid.json()["AudioIns"][0]["SubDevices"][0]["Id"]
data2['body']['SubDevices'][1]["Id"] = deviceid.json()["AudioIns"][0]["SubDevices"][1]["Id"]
