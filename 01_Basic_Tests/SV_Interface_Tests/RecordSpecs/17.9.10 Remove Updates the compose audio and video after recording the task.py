...
def S4E7_Basic():
    ...
    databody = {
        ...
        "SpecNames": [
            ...
            "remote2_Record",
            "remote3_Record",
            "AudioInDefault_aac_Codec",
            "Audio_pull_aac_Codec",
            "Audio_pull_aac2_Codec",
            "Audio_pull_aac3_Codec",
            "Director_Codec",
            "Remote_pull_h264_Codec",
            "Remote_pull_2_h264_Codec",
            "Remote_pull_3_h264_Codec",
        ]
    }
