...
def create_4_IPC_record(IP):
    cre_4_IPC_re_data = read_json_file('create_4_IPC_Record_no_Preview.json')
    ...
    if response.json()['Code'] == 201:
        print('Create 4 IPC With 2 Record No Preview Success!')
    else:
        print('Create 4 IPC With 2 Record No Preview Failed!')
