...
scriptlist = [
    ...
    'create_update.py -mn=Basic_MCS -jf=CM_T_S_RT_Render -ip={}'.format(Near_IP),
    'create_update.py -mn=Basic_MCS -jf=CM_T_S_PC_Record -ip={}'.format(Near_IP),
    ...
    'remove.py -mn=Basic_MCS -sn=Compositor,Compositor_Record -ip={}'.format(Near_IP),
    'create_update.py -mn=Basic_MCS -jf=04_D_T_S_Compose -ip={}'.format(Near_IP),
    'CM_Record.py -mn=Basic_MCS -rn=D_T_S -ip={}'.format(Near_IP),
    'remove.py -mn=Basic_MCS -sn=Compositor,Compositor_Record -ip={}'.format(Near_IP),
    'create_update.py -mn=Basic_MCS -jf=05_D_T_S_PC_Compose -ip={}'.format(Near_IP),
    'CM_Record.py -mn=Basic_MCS -rn=D_T_S_PC -ip={}'.format(Near_IP),
    'remove.py -mn=Basic_MCS -sn=Compositor,Compositor_Record -ip={}'.format(Near_IP),
    'remove.py -mn=Basic_MCS -sn=Teacher_Record,Student_Record,Computer_Record -ip={}'.format(Near_IP),
    'remove.py -mn=Basic_MCS -sn=Teacher_h264_Codec,Student_h264_Codec,Computer_h264_Codec -ip={}'.format(Near_IP),
    'create_update.py -mn=Basic_MCS -jf=06_D_RW_Compose -ip={}'.format(Near_IP),
    'CM_Record.py -mn=Basic_MCS -rn=D_RW -ip={}'.format(Near_IP),
    'remove.py -mn=Basic_MCS -sn=Compositor,Compositor_Record -ip={}'.format(Near_IP)
]


def act_basic(ScriptList, sleeptime=10):
    # 先依次执行前面操作
