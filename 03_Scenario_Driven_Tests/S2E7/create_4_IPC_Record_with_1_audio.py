...
def create_4_IPC_record(IP):
    cre_4_IPC_re_data = read_json_file('create_4_IPC_Record_with_1_audio.json')
    ...
    if response.json()['Code'] == 201:
        print('Create 4 IPC With 1 Audio Record Success!')
    else:
        print('Create 4 IPC With 1 Audio Record Failed!')
