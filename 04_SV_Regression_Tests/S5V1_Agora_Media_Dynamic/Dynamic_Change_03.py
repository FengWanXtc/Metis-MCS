...
def mcs_task(host_ip):
    mcs_data = read_json_file('Dynamic_Change_03.json')
    ...
    if response.json()['Code'] == 201:
        print('Dynamic Change 03 MCS *{}* Post Success'.format(task_name))
        return True
    else:
        print('Dynamic Change 03 MCS *{}* Post Fail'.format(task_name))
        print(response.json())
        return False
