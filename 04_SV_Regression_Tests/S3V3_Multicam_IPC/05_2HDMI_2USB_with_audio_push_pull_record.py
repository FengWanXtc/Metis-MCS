...
if __name__ == '__main__':
    ...
    input(Anno + "\nPlease Press Enter Key to Delete Frame 2 Task.")
    os.system('python delete_task_by_name.py -n=HDMI2 -ip={}'.format(Host_IP))

    input(Anno + "\nPlease Press Enter Key to Start HDMI2 Record Task.")
    os.system('python create_preview_with_record.py -d={} -p=2 -mn=HDMI2 -n=HDMI2 -ip={}'.format(Global_StudentCamType,Host_IP))
    # 删除2个USB回显
    input(Anno + "\nPlease Press Enter Key to Delete 2 USB and HDMI2 Preview Tasks")
    ...
    input(Anno + "\nPlease Press Enter Key to Add 2 USB Preview with Record Tasks.")
    os.system('python create_preview_with_record.py  -d={} -p=3 -mn=USB1 -n=USB1 -ip={}'.format(Global_BlackBoardCamType,Host_IP))
    os.system('python create_preview_with_record.py  -d={} -p=4 -mn=USB2 -n=USB2 -ip={}'.format(Global_PPTCamType,Host_IP))
    # 删除近端与远端全部任务
