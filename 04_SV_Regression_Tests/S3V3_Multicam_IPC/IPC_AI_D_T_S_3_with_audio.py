...
def create_preview_IPC(ip):
    cr_pr_IPC_data = read_json_file('IPC_AI_D_T_S_3_with_audio.json')
    # 填写MCS模板内容
    ...
    cr_pr_IPC_data["VideoSpecs"][2]["DeviceId"] = item["DeviceId"]
    # print(cr_pr_IPC_data["VideoSpecs"])
    ...
    if (response.json()['Code'] == 201):
        print('Create IPC AI 3 Frames Success')
        return True
    else:
        print('Create IPC AI 3 Frames Fail')
        return False
