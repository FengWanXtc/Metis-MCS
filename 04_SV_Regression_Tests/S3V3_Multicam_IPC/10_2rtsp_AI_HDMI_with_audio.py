...
if __name__ == '__main__':
    ...
    os.system('python IPC_AI_HDMI_D_2.py -ip={}'.format(IP))

    # 删除导播任务
    input(Anno + "\nPlease Press Enter Key to Delete Director Tasks.")
    os.system('python delete_task_by_name.py -n=IPC_AI_D_T_HDMI'.format(IP))

    # 开启加audio推流录制任务
    input(Anno + "\nPlease Press Enter Key to  *Create AI 2 Frame with Audio* Tasks.")
    os.system('python IPC_AI_HDMI_D_2_with_audio.py -ip={}'.format(IP))
